...
def main():
    ...
    n = 9
    smis = ['C[N+](C)(C)CCCCCCCCCCCC' for _ in range(n)]
    structures = []
    for i in range(1, n + 1):
        fname = 'C12_c{}.out.mfj.xyzmq'.format(i)
    ...
    savetxt('C12_X_CUST.txt', X_cust)
    savetxt('C12_X_MQN.txt', X_mqn)
    savetxt('C12_X_MD3D.txt', X_md3d)
    savetxt('C12_X_COMB.txt', X_comb)
