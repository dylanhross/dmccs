...
def main():
    ...
    n = 6
    smis = ['C[N+](C)(C)CCCCCCCCCCO' for _ in range(n)]
    structures = []
    for i in range(1, n + 1):
        fname = 'C10OH_c{}.out.mfj.xyzmq'.format(i)
    ...
    savetxt('C10OH_X_CUST.txt', X_cust)
    savetxt('C10OH_X_MQN.txt', X_mqn)
    savetxt('C10OH_X_MD3D.txt', X_md3d)
    savetxt('C10OH_X_COMB.txt', X_comb)
