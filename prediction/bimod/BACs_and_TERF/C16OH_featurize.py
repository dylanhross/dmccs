...
def main():
    ...
    n = 8
    smis = ['C[N+](C)(C)CCCCCCCCCCCCCCCCO' for _ in range(n)]
    structures = []
    for i in range(1, n + 1):
        fname = 'C16OH_c{}.out.mfj.xyzmq'.format(i)
    ...
    savetxt('C16OH_X_CUST.txt', X_cust)
    savetxt('C16OH_X_MQN.txt', X_mqn)
    savetxt('C16OH_X_MD3D.txt', X_md3d)
    savetxt('C16OH_X_COMB.txt', X_comb)
