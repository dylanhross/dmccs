...
def main():
    ...
    n = 9
    smis = ['C[N+](C)(C)CCCCCCCCCCCCCC' for _ in range(n)]
    structures = []
    for i in range(1, n + 1):
        fname = 'C14_c{}.out.mfj.xyzmq'.format(i)
    ...
    savetxt('C14_X_CUST.txt', X_cust)
    savetxt('C14_X_MQN.txt', X_mqn)
    savetxt('C14_X_MD3D.txt', X_md3d)
    savetxt('C14_X_COMB.txt', X_comb)
