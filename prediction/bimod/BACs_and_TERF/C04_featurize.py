...
def main():
    ...
    n = 4
    smis = ['C[N+](C)(C)CCCC' for _ in range(n)]
    structures = []
    for i in range(1, n + 1):
        fname = 'C04_c{}.out.mfj.xyzmq'.format(i)
    ...
    savetxt('C04_X_CUST.txt', X_cust)
    savetxt('C04_X_MQN.txt', X_mqn)
    savetxt('C04_X_MD3D.txt', X_md3d)
    savetxt('C04_X_COMB.txt', X_comb)
