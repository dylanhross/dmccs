...
def main():
    ...
    n = 8
    smis = ['C[N+](C)(C)CCCCCCCCCCCCO' for _ in range(n)]
    structures = []
    for i in range(1, n + 1):
        fname = 'C12OH_c{}.out.mfj.xyzmq'.format(i)
    ...
    savetxt('C12OH_X_CUST.txt', X_cust)
    savetxt('C12OH_X_MQN.txt', X_mqn)
    savetxt('C12OH_X_MD3D.txt', X_md3d)
    savetxt('C12OH_X_COMB.txt', X_comb)
