...
def main():
    ...
    n = 7
    smis = ['C[N+](C)(C)CCCCCCCC' for _ in range(n)]
    structures = []
    for i in range(1, n + 1):
        fname = 'C08_c{}.out.mfj.xyzmq'.format(i)
    ...
    savetxt('C08_X_CUST.txt', X_cust)
    savetxt('C08_X_MQN.txt', X_mqn)
    savetxt('C08_X_MD3D.txt', X_md3d)
    savetxt('C08_X_COMB.txt', X_comb)
