...
# raw files
rf1 = 'D:/DMIM_HT/data/20191107/DHR20191107_p724_M21_pos.raw'
rf2 = 'D:/DMIM_HT/data/20191202/DHR20191202_p724_M21_pos.raw'
rf3 = 'D:/DMIM_HT/data/20191203/DHR20191203_p724_M21_pos.raw'
...
cd1 = get_ccs_dist(rf1, 2, 360.1723, 0.05, cf1)
cd2 = get_ccs_dist(rf2, 1, 360.1723, 0.05, cf2)
cd3 = get_ccs_dist(rf3, 1, 360.1723, 0.05, cf3)

# plot atds 
plot_replicate_ccs_dists('enro', cd1, cd2, cd3, x_range=[140, 220])
plot_replicate_ccs_dists('enro', cd1, cd2, cd3, norm=True, x_range=[140, 220])
