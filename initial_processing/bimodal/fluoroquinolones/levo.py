...
# raw files
rf1 = 'D:/DMIM_HT/data/20200127/DHR20200127_p723_D15_pos.raw'
rf2 = 'D:/DMIM_HT/data/20191209/DHR20191209_p723_D15_pos.raw'
rf3 = 'D:/DMIM_HT/data/20191210/DHR20191210_p723_D15_pos.raw'
...
cd1 = get_ccs_dist(rf1, 2, 362.1516, 0.05, cf1)
cd2 = get_ccs_dist(rf2, 1, 362.1516, 0.05, cf2)
cd3 = get_ccs_dist(rf3, 1, 362.1516, 0.05, cf3)

# plot atds 
plot_replicate_ccs_dists('levo', cd1, cd2, cd3)
plot_replicate_ccs_dists('levo', cd1, cd2, cd3, norm=True, x_range=[140, 220])
