...
polya_base = 'D:/DMIM_HT/data/20191216/DHR20191216_polyala_pos_{:1d}.raw'
drugs_base = 'D:/DMIM_HT/data/20191216/DHR20191216_drugs_pos_{:1d}.raw'
cal_data_pairs = [[polya_base.format(i), drugs_base.format(i)] for i in range(1, 4)]
